...
import Terminal.PlanMenorPrecioTotal;
...
class MenorPrecioTotalTest {
	...
	PlanMenorPrecioTotal planMenorPrecioTotal;
	...
	void setUp() throws Exception {
		...
		planMenorPrecioTotal = new PlanMenorPrecioTotal();
	
	}

	@Test
	void testOperacion() {
		assertEquals(circuitoMasCorto, planMenorPrecioTotal.operacion(BuenosAires, Marsella, circuitos));
	}
	
	@Test
	void testCalcularCostoTotal() {
		assertEquals(3000.0, planMenorPrecioTotal.calcularCostoTotal(circuitoMasCorto));
	}
