...
class PlanMenorTiempoTest {
	...
	PlanMenorTiempo planMenorTiempo;
	...
	void setUp() throws Exception {
		...
		planMenorTiempo = new PlanMenorTiempo();
	
	}

	@Test
	void testOperacion() {
		assertEquals(circuitoMasCorto , planMenorTiempo.operacion(BuenosAires, Marsella, circuitos));	
	}
	
	@Test
	void testcalcularTiempoTotal() {
		assertEquals(300.0, planMenorTiempo.calcularTiempoTotal(listaCorta));	
	}
	
	
	@Test
	void testIniciaConTerminal() {
		assertEquals(true, circuitoMasCorto.iniciaConTerminal(BuenosAires));	
	}

	@Test
	void testTerminaConTerminal() {
		assertEquals(true, circuitoMasCorto.terminaConTerminal(Marsella));	
	}
